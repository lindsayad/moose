...
# class Test2DRCSymmetry():
    def test(self):
        labels = ['L2u', 'L2v', 'L2p']
        df1 = mms.run_spatial('2d-rc-symmetry.i', list(range(1,6)), "--error", y_pp=labels, mpi=8)
...
# class Test2DRZRCSymmetry():
    def test(self):
        labels = ['L2u', 'L2v', 'L2p']
        df1 = mms.run_spatial('2d-rc-rz-symmetry.i', list(range(1,6)), "--error", y_pp=labels, mpi=8)
