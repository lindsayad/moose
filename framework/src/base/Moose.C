...
const ExecFlagType EXEC_FIXED_POINT_INITIAL("FIXED_POINT_INITIAL");
const ExecFlagType EXEC_FIXED_POINT_POST_TIMESTEP_BEGIN("FIXED_POINT_POST_TIMESTEP_BEGIN");
const ExecFlagType
    EXEC_FIXED_POINT_POST_TIMESTEP_BEGIN_AGAIN("FIXED_POINT_POST_TIMESTEP_BEGIN_AGAIN");
namespace Moose
{
...
registerExecFlags(Factory & factory)
{
  ...
  registerExecFlag(EXEC_FIXED_POINT_INITIAL);
  registerExecFlag(EXEC_FIXED_POINT_POST_TIMESTEP_BEGIN);
  registerExecFlag(EXEC_FIXED_POINT_POST_TIMESTEP_BEGIN_AGAIN);
}
