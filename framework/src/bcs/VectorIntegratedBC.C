...
VectorIntegratedBC::VectorIntegratedBC(const InputParameters & parameters)
  : IntegratedBCBase(parameters), // False is because this is NOT nodal
    _var(dynamic_cast<MooseVariableVector &>(_base_var)),
    _normals(_var.normals()),
    _phi(_assembly.vectorPhiFace()),
    _curl_phi(_assembly.vectorCurlPhiFace()),
    _test(_var.phiFace()),
