...
public:
  ...
  std::vector<MooseArray<Real>> _zero;
  std::vector<MooseArray<VectorValue<Real>>> _grad_zero;
  std::vector<MooseArray<TensorValue<Real>>> _second_zero;
  std::vector<MooseArray<std::vector<TensorValue<Real>>>> _second_phi_zero;
  ///@}
