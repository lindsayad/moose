...
/**
 * The DGKernelBase includes the common functionality between DGKernel and InterfaceKernel.
 *
 */
...
protected:
  ...
  /// Holds residual entries as they are accumulated by this DGKernelBase
